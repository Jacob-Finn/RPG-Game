...
func StartingTheSetup() -> Player
{
    ...
    return Player(health: 100, coins: startingMoney, name: startingName, monstersKilled: 0, chestplate: noChestplate, helmet: noHelmet, greaves: noGreaves, defence: 0, strength: 5, agility: 5, intelligence: 5, dead: false, abilityActive: false)
